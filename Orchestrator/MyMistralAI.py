...
def to_mistral_chatmessage(
    ...
    for m in messages:
        ...
        if m.role == MessageRole.USER:
            ...
            new_messages.append(ToolMessage(content=m.content,tool_call_id=m.additional_kwargs.get("tool_call_id"),
                                            name=m.additional_kwargs.get("tool_name")))
        else:
...
class MyMistralAI(FunctionCallingLLM):
    """MistralAI LLM.
